...
pub use sidecar::{
    ...
    extract_front_matter, find_sidecar_path, parse_sidecar, parse_tag, preview_tag_rules,
    resolve_inferred_tags, resolve_tags, resolve_tags_with_warnings, FileMetadata, InferredTag,
    ResolvedTagsResult, RootSidecarData, SidecarData, TagRule, TagRuleMatch, SIDECAR_FILENAME,
};
